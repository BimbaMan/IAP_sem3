...
//vasya@pupkin.ru ivan.ivanov@mail.bsuir.by a.b.c@d-e-f.com фыввы@com maksvartanjan@gmail.com s@n
...
void printSubStrings(char* words[SIZE], int numWords) {
    bool isCorrect = true; unsigned int cnt = 1;
...
#pragma endregion
    ...
    if (isCorrect) {
        printf("\nСтрока не корректна, нельзя выделить корректные подстроки\n");
    }
}
